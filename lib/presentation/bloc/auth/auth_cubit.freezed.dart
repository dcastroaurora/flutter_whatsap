...
// ignore: unused_element
  _Authenticated authenticated(String uid) {
...
mixin _$AuthState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result authenticated(String uid),
    @required Result unauthenticated(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result inital(),
    Result authenticated(String uid),
...
class _$_Authenticated implements _Authenticated {
  const _$_Authenticated(this.uid) : assert(uid != null);
...
abstract class _Authenticated implements AuthState {
  const factory _Authenticated(String uid) = _$_Authenticated;
